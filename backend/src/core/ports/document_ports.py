...
from core.repo.document_repo import (
    DELETE_DOCUMENT_MESSAGES_BY_PROCESS, GET_DOCUMENT_TEMPLATE_FILE_BY_TYPE_AND_MIME, GET_TEMPLATE_BY_TYPE_AND_MIME,
    ...
    GET_TEMPLATE_BY_TYPE_ID, UPDATE_DOCUMENT_FILE, UPDATE_DOCUMENT_STATUS, UPDATE_DOCUMENT_TEMPLATE,
...
class DocumentPorts:
    ...
    @staticmethod
    def get_template_by_type_id_and_mime_type(document_type_id: int, mime_type: str) -> dict | None:
        return adapter.fetch_one(GET_TEMPLATE_BY_TYPE_ID_AND_MIME_TYPE, (document_type_id, mime_type))

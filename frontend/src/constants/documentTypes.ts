export const BACKEND_DOCUMENT_TYPES = {
    ...
    STUDENT_PARTIAL_REPORT_3: 'student_partial_report_3',
    SUPERVISOR_PARTIAL_REPORT_3: 'supervisor_partial_report_3',
...
export const DOCUMENT_TYPE_IDS: Record<string, number | undefined> = {
    ...
    [BACKEND_DOCUMENT_TYPES.STUDENT_PARTIAL_REPORT_3]: 11,
    [BACKEND_DOCUMENT_TYPES.SUPERVISOR_PARTIAL_REPORT_3]: 12,
...
export const DOCUMENT_TITLES: Record<string, string> = {
    ...
    [BACKEND_DOCUMENT_TYPES.STUDENT_PARTIAL_REPORT_3]: 'Relatório Parcial 3 - Aluno',
    [BACKEND_DOCUMENT_TYPES.SUPERVISOR_PARTIAL_REPORT_3]: 'Relatório Parcial 3 - Orientador',
